...
Source3  : https://repo1.maven.org/maven2/org/apache/ivy/ivy/2.3.0/ivy-2.3.0.jar
Source4  : https://repo1.maven.org/maven2/org/apache/ivy/ivy/2.3.0/ivy-2.3.0.pom
Source5  : https://repo1.maven.org/maven2/org/apache/ivy/ivy/2.4.0/ivy-2.4.0.pom
...
%package data
Summary: data components for the mvn-ivy package.
Group: Data
...
mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/ivy/ivy/2.3.0
cp %{SOURCE3} %{buildroot}/usr/share/java/.m2/repository/org/apache/ivy/ivy/2.3.0/ivy-2.3.0.jar

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/ivy/ivy/2.3.0
cp %{SOURCE4} %{buildroot}/usr/share/java/.m2/repository/org/apache/ivy/ivy/2.3.0/ivy-2.3.0.pom

mkdir -p %{buildroot}/usr/share/java/.m2/repository/org/apache/ivy/ivy/2.4.0
cp %{SOURCE5} %{buildroot}/usr/share/java/.m2/repository/org/apache/ivy/ivy/2.4.0/ivy-2.4.0.pom
...
/usr/share/java/.m2/repository/org/apache/ivy/ivy/2.3.0/ivy-2.3.0.jar
/usr/share/java/.m2/repository/org/apache/ivy/ivy/2.3.0/ivy-2.3.0.pom
